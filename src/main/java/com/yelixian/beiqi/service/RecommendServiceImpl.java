...
public class RecommendServiceImpl extends RecommendGrpc.RecommendImplBase {
    ...
    public void mainRecommend(CommonRequest req, StreamObserver<RecommendVideoReply> responseObserver) {
        RecommendVideoReply reply = RecommendVideoReply.newBuilder()
                ...
                .setVideoList(8, Video.newBuilder()
                        ...
                        .setTailDuration(235)
                        .build())
                .setVideoList(9, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("nn5tdypc")
                        .setVcode("dsdad70p")
                        .setVideoLabel(VideoLabel.VIDEO)
    ...
    public void keywordRecommend(CommonRequest req, StreamObserver<HotKeywordReply> responseObserver) {
        HotKeywordReply reply = HotKeywordReply.newBuilder()
                .setKeywordList(0, Keyword.newBuilder().setKeyword("小猪佩奇").setResultNum(9).build())
                .setKeywordList(1, Keyword.newBuilder().setKeyword("汪汪队立大功").setResultNum(5).build())
                .setKeywordList(2, Keyword.newBuilder().setKeyword("熊出没").setResultNum(23).build())
                .setKeywordList(3, Keyword.newBuilder().setKeyword("小马宝莉").setResultNum(8).build())
                .setKeywordList(4, Keyword.newBuilder().setKeyword("海绵宝宝").setResultNum(15).build())
                .setKeywordList(5, Keyword.newBuilder().setKeyword("赛车总动员").setResultNum(2).build())
                .setKeywordList(6, Keyword.newBuilder().setKeyword("超级飞侠").setResultNum(6).build())
                .setKeywordList(7, Keyword.newBuilder().setKeyword("大头儿子小头爸爸").setResultNum(16).build())
                .setKeywordList(8, Keyword.newBuilder().setKeyword("海底小纵队").setResultNum(6).build())
                .setKeywordList(9, Keyword.newBuilder().setKeyword("爸爸去哪儿").setResultNum(13).build())
                .setErrCode(0)
                .setErrMessage("")
                .build();
        responseObserver.onNext(reply);
