...
public class UserVideoRelationServiceImpl extends UserVideoRelationGrpc.UserVideoRelationImplBase {
    ...
    public void getUserRecord(CommonRequest req, StreamObserver<RecordReply> responseObserver) {
        RecordReply reply = RecordReply.newBuilder()
                .setWatchList(0, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("x3rtewwp")
                        .setVcode("tvv7unts")
                        ...
                        .build())
                .setWatchList(1, Video.newBuilder()
                        .setCcode("kx4y72sg")
                        .setEcode("t3rtewwp")
                        .setVcode("vvv7unts")
                        .setVideoLabel(VideoLabel.VIDEO)
                        ...
                        .build())
                .setWatchList(2, Video.newBuilder()
                        .setCcode("hx4y72sg")
                        .setEcode("l3rtewwp")
                        .setVcode("nvv7unts")
                        .setVideoLabel(VideoLabel.VIDEO)
                        ...
                        .build())
                .setWatchList(3, Video.newBuilder()
                        .setCcode("ax4y72sg")
                        .setEcode("b3rtewwp")
                        .setVcode("cvv7unts")
                        .setVideoLabel(VideoLabel.VIDEO)
                        ...
                        .build())
                .setWatchList(4, Video.newBuilder()
                        .setCcode("px4y72sg")
                        .setEcode("q6rtewwp")
                        .setVcode("ssv7unts")
                        .setVideoLabel(VideoLabel.VIDEO)
                        ...
                        .build())
                .setFavorList(0, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("x3rtewwp")
                        .setVcode("tvv7unts")
                        .setVideoLabel(VideoLabel.VIDEO)
                        ...
                        .setOperationTimestamp(1526326398)
                        .build())
                .setFavorList(1, Video.newBuilder()
                        .setCcode("kx4y72sg")
                        .setEcode("t3rtewwp")
                        .setVcode("vvv7unts")
                        .setVideoLabel(VideoLabel.VIDEO)
                        ...
                        .setOperationTimestamp(1526067018)
                        .build())
                .setFavorList(2, Video.newBuilder()
                        .setCcode("hx4y72sg")
                        .setEcode("l3rtewwp")
                        .setVcode("nvv7unts")
                        .setVideoLabel(VideoLabel.VIDEO)
                        ...
                        .setOperationTimestamp(1525980651)
                        .build())
                .setFavorList(3, Video.newBuilder()
                        .setCcode("ax4y72sg")
                        .setEcode("b3rtewwp")
                        .setVcode("cvv7unts")
                        .setVideoLabel(VideoLabel.VIDEO)
                        ...
                        .setOperationTimestamp(1525807511)
                        .build())
                .setKeywordList(0, Keyword.newBuilder()
                        .setKeyword("小猪佩奇")
                        .setResultNum(9)
                        .setOperationTimestamp(1526326398)
                        .build())
                .setKeywordList(1, Keyword.newBuilder()
                        .setKeyword("汪汪队立大功")
                        .setResultNum(6)
                        .setOperationTimestamp(1526067018)
                        .build())
                .setKeywordList(2, Keyword.newBuilder()
                        .setKeyword("熊出没")
                        .setResultNum(13)
                        .setOperationTimestamp(1525980618)
                        .build())
                .setKeywordList(3, Keyword.newBuilder()
                        .setKeyword("海绵宝宝")
                        .setResultNum(7)
                        .setOperationTimestamp(1525807511)
                        .build())
                .setKeywordList(4, Keyword.newBuilder()
                        .setKeyword("赛车总动员")
                        .setResultNum(2)
                        .setOperationTimestamp(1525806668)
                        .build())
                .setKeywordList(5, Keyword.newBuilder()
                        .setKeyword("海底小纵队")
                        .setResultNum(8)
    ...
    public void getChannelInfo(GetChannelInfoRequest req, StreamObserver<ChannelReply> responseObserver) {
        ChannelReply reply = ChannelReply.newBuilder()
                ...
                .setProducer("E1 Kids")
                .setEpisodeList(0, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("eq341yex")
                        .setVcode("")
                        ...
                        .setType("cartoon")
                        .build())
                .setEpisodeList(1, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("y71yrh5e")
                        .setVcode("")
                        .setVideoLabel(VideoLabel.EPISODE)
                        ...
                        .setType("cartoon")
                        .build())
                .setEpisodeList(2, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("x3rtewwp")
                        .setVcode("")
                        .setVideoLabel(VideoLabel.EPISODE)
                        ...
                        .setType("cartoon")
                        .build())
                .setEpisodeList(3, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("ioren7nf")
                        .setVcode("")
                        .setVideoLabel(VideoLabel.EPISODE)
                        ...
                        .setType("cartoon")
                        .build())
                .setEpisodeList(4, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("tyiu3daf")
                        .setVcode("")
                        .setVideoLabel(VideoLabel.EPISODE)
                        ...
                        .setType("cartoon")
                        .build())
                .setEpisodeList(5, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("mmew3f0p")
                        .setVcode("")
                        .setVideoLabel(VideoLabel.EPISODE)
                        ...
                        .setType("cartoon")
                        .build())
                .setEpisodeList(6, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("poda47nc")
                        .setVcode("")
                        .setVideoLabel(VideoLabel.EPISODE)
                        ...
                        .setType("cartoon")
                        .build())
                .setEpisodeList(7, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("ipds5dsz")
                        .setVcode("")
                        .setVideoLabel(VideoLabel.EPISODE)
                        ...
                        .setType("cartoon")
                        .build())
                .setEpisodeList(8, Video.newBuilder()
                        .setCcode("ux4y72sg")
                        .setEcode("ds23fy6d")
                        .setVcode("")
                        .setVideoLabel(VideoLabel.EPISODE)
